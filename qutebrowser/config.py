config.load_autoconfig(False) # This is dumb, dont change this
c.backend = 'webengine' # Dont change this
...
c.colors.statusbar.command.bg = '#191919'
...
c.colors.statusbar.normal.bg = '#191919'
## Foreground color of the statusbar.
c.colors.statusbar.normal.fg = 'seagreen'
########################################
...
c.colors.tabs.selected.even.bg = '#228b22'

## Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = 'white'

## Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = '#228b22'
...
## Type: ShellCommand
c.editor.command = [terminal, 'nvim', '{file}']
